...
// Doc EN URLs per channel (anchors on https://sealclaw.io/docs/channels)
const CHANNEL_DOC_EN_URLS: Partial<Record<ChannelKey, string>> = {
  dingtalk:
    "https://sealclaw.io/docs/channels/?lang=en#DingTalk-recommended",
  feishu: "https://sealclaw.io/docs/channels/?lang=en#Feishu-Lark",
  imessage:
    "https://sealclaw.io/docs/channels/?lang=en#iMessage-macOS-only",
  discord: "https://sealclaw.io/docs/channels/?lang=en#Discord",
  qq: "https://sealclaw.io/docs/channels/?lang=en#QQ",
  telegram: "https://sealclaw.io/docs/channels/?lang=en#Telegram",
  mqtt: "https://sealclaw.io/docs/channels/?lang=en#MQTT",
  mattermost: "https://sealclaw.io/docs/channels/?lang=en#Mattermost",
  matrix: "https://sealclaw.io/docs/channels/?lang=en#Matrix",
  wecom: "https://sealclaw.io/docs/channels/?lang=en#WeCom-WeChat-Work",
  xiaoyi:
    "https://developer.huawei.com/consumer/cn/doc/service/openclaw-0000002518410344",
};

// Doc ZH URLs per channel (anchors on https://sealclaw.io/docs/channels)
const CHANNEL_DOC_ZH_URLS: Partial<Record<ChannelKey, string>> = {
  dingtalk: "https://sealclaw.io/docs/channels/?lang=zh#钉钉推荐",
  feishu: "https://sealclaw.io/docs/channels/?lang=zh#飞书",
  imessage:
    "https://sealclaw.io/docs/channels/?lang=zh#iMessage仅-macOS",
  discord: "https://sealclaw.io/docs/channels/?lang=zh#Discord",
  qq: "https://sealclaw.io/docs/channels/?lang=zh#QQ",
  telegram: "https://sealclaw.io/docs/channels/?lang=zh#Telegram",
  mqtt: "https://sealclaw.io/docs/channels/?lang=zh#MQTT",
  mattermost: "https://sealclaw.io/docs/channels/?lang=zh#Mattermost",
  matrix: "https://sealclaw.io/docs/channels/?lang=zh#Matrix",
  wecom: "https://sealclaw.io/docs/channels/?lang=zh#企业微信",
  xiaoyi:
    "https://developer.huawei.com/consumer/cn/doc/service/openclaw-0000002518410344",
};
        ...
        return (
          <>
            ...
            <Form.Item name="media_dir" label="Media Dir">
              <Input placeholder="~/.sealclaw/media" />
            </Form.Item>
          </>
        );
      ...
      case "mattermost":
        return (
          <>
            ...
            <Form.Item name="media_dir" label="Media Dir">
              <Input placeholder="~/.sealclaw/media/mattermost" />
            </Form.Item>
            <Form.Item
              name="show_typing"
              label="Show Typing"
