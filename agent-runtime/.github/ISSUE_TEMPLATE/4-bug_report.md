...
[Provide the version of SealClaw you are using, e.g. 0.x.x or git commit hash.]
[Using `sealclaw --version` in your command line or checking the version in the console UI can help.]
...
- **SealClaw version:** [e.g. 0.x.x or git commit]
