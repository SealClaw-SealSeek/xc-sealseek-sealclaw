...
**MCP (Model Context Protocol)** allows SealClaw to connect to external MCP servers and use their tools. You can add MCP clients through the Console to extend SealClaw's capabilities.
...
SealClaw supports three JSON formats for importing MCP clients:
