...
export const i18n: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "usecases.creative.1":
      "睡前向 SealClaw 说明目标并设定自动执行，次日即可获得可用的雏形。",
    "usecases.creative.2":
      "从选题、找素材到确定方向，SealClaw 可协助完成视频内容创作全流程。",
    ...
    "usecases.productivity.3":
      "记录饮食与身体反应，由 SealClaw 定期分析并呈现规律。",
    "usecases.research.1":
    ...
    "quickstart.hintAfter": "，即可通过钉钉、飞书、QQ 等频道使用 SealClaw。",
  ...
  en: {
    ...
    "follow.sub": "Follow us for the latest SealClaw updates",
    "follow.xiaohongshu": "Rednote:",
    "follow.x": "X:",
    "brandstory.title": "Why SealClaw?",
    "brandstory.para1":
      'SealClaw represents both a Co Personal Agent Workstation and a "co-paw"—a partner always by your side.',
    "brandstory.para2":
      'More than just a cold tool, SealClaw is a warm "little paw" always ready to lend a hand (or a paw!). It is the ultimate teammate for your digital life.',
    ...
    "usecases.title": "What you can do with SealClaw",
    "usecases.sub": "",
    ...
    "usecases.creative.1":
      "Describe your goal to SealClaw and set it to run overnight; get a working draft by the next day.",
    "usecases.creative.2":
      "From topic selection and material gathering to direction setting, SealClaw supports the full video content workflow.",
    "usecases.productivity.1":
    ...
    "usecases.productivity.3":
      "Log diet and symptoms; SealClaw analyzes and surfaces patterns over time.",
    "usecases.research.1":
    ...
    "quickstart.hintBefore":
      "Install → init → start. Configure channels to use SealClaw on DingTalk, Feishu, QQ, etc. See ",
    ...
    "quickstart.badgeBeta": "Beta",
    footer: "SealClaw — Works for you, grows with you",
