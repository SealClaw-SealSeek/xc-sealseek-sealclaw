...
const DOCKER_IMAGE = "agentscope/sealclaw:latest";
const MODELSCOPE_URL =
  "https://modelscope.cn/studios/fork?target=AgentScope/SealClaw";
...
const COMMANDS = {
  pip: ["pip install sealclaw", "sealclaw init --defaults", "sealclaw app"],
  scriptMac: [
  ...
  docker: [
    ...
    `docker run -p 127.0.0.1:8088:8088 -v sealclaw-data:/app/working -v sealclaw-secrets:/app/working.secret ${DOCKER_IMAGE}`,
  ],
} as const;
