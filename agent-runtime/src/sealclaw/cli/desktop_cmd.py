# -*- coding: utf-8 -*-
"""CLI command: run SealClaw app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run SealClaw app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing SealClaw app instance.
    """
    ...
    click.echo(f"Starting SealClaw app on {url} (port {port})")
