...
def chats_group() -> None:
    ...
    \b
    Common examples:
      sealclaw chats list                    # List all chats
      sealclaw chats list --user-id alice    # Filter by user
      sealclaw chats get <chat_id>           # View details
      sealclaw chats create --session-id s1 --user-id u1
      sealclaw chats delete <chat_id>        # Delete a chat
    """
...
def list_chats(
    ...
    Examples:
      sealclaw chats list
      sealclaw chats list --user-id alice
      sealclaw chats list --channel discord
      sealclaw chats list --user-id alice --channel discord
    """
...
def get_chat(
    ...
    \b
    CHAT_ID  Chat UUID, obtainable via `sealclaw chats list`.
...
def create_chat(
    ...
    Inline creation examples:
      sealclaw chats create --session-id "discord:alice" \\
    ...
    JSON file creation example:
      sealclaw chats create -f chat.json
    """
    base_url = _base_url(ctx, base_url)
...
def update_chat(
    ...
    \b
    Examples:
      sealclaw chats update <chat_id> --name "Renamed Chat"
    """
    base_url = _base_url(ctx, base_url)
    headers = {"X-Agent-Id": agent_id}
...
def delete_chat(
    ...
    \b
    Examples:
      sealclaw chats delete 823845fe-dd13-43c2-ab8b-d05870602fd8
    """
    base_url = _base_url(ctx, base_url)
    with client(base_url) as c:
        headers = {"X-Agent-Id": agent_id}
