# -*- coding: utf-8 -*-
"""Token counting utilities for SealClaw using HuggingFace tokenizers.
...
class CopawTokenCounter(HuggingFaceTokenCounter):
    """Token counter for SealClaw with configurable tokenizer support.
...
def get_sealclaw_token_counter(
