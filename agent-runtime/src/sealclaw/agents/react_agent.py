# -*- coding: utf-8 -*-
"""SealClaw Agent - Main agent implementation.

This module provides the main SealClawAgent class built on ReActAgent,
...
class SealClawAgent(ToolGuardMixin, ReActAgent):
    """SealClaw Agent with integrated tools, skills, and memory management.
    ...
    Python's MRO: SealClawAgent → ToolGuardMixin → ReActAgent.  If you
    ...
    **must** call ``super()._acting(...)`` / ``super()._reasoning(...)``
    ...
    def _rebuild_mcp_client(client: Any) -> Any | None:
        ...
        rebuild_info = getattr(client, "_sealclaw_rebuild_info", None)
        ...
        try:
            if transport == "stdio":
                ...
                setattr(rebuilt_client, "_sealclaw_rebuild_info", rebuild_info)
                return rebuilt_client
