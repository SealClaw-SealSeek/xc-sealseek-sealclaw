...
"""Memory Manager for SealClaw agents.
...
from sealclaw.agents.model_factory import create_model_and_formatter
from sealclaw.agents.tools import read_file, write_file, edit_file
from sealclaw.agents.utils import get_sealclaw_token_counter
from sealclaw.config.config import load_agent_config
...
class MemoryManager(ReMeLight):
    """Memory manager that extends ReMeLight for SealClaw agents.
    ...
    async def compact_memory(
        ...
        **_kwargs,
        ...
        token_counter = get_sealclaw_token_counter(agent_config)
