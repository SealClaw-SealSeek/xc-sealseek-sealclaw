...
from sealclaw.config.config import (
    AgentProfileConfig,
    load_agent_config,
    save_agent_config,
)
...
def mock_agent_workspace(tmp_path, monkeypatch):
    ...
    import json
    from sealclaw.config.utils import get_config_path
    from sealclaw.config.config import Config, AgentsConfig, AgentProfileRef
