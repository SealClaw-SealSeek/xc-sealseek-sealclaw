...
from sealclaw.agents.utils.sealclaw_token_counter import (
    CopawTokenCounter,
    get_sealclaw_token_counter,
)
import sealclaw.agents.utils.sealclaw_token_counter as token_counter_module
...
def test_cache_returns_same_instance_for_same_config() -> None:
    ...
    counter1 = get_sealclaw_token_counter(mock_config)
    counter2 = get_sealclaw_token_counter(mock_config)
...
def test_different_config_creates_new_instance() -> None:
    ...
    counter1 = get_sealclaw_token_counter(mock_config1)
    counter2 = get_sealclaw_token_counter(mock_config2)
